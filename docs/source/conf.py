# -*- coding: utf-8 -*-
#
# pyscripts documentation build configuration file, created by
...
# pyscripts.core.decorate (which calls functools.wrap), only "*args, **kwargs"
...
def no_op_wraps( func ):
    ...
    Sphinx documentation. This must be done before "pyscripts" is imported.
    '''
    if func.__module__ is None or 'pyscripts' not in func.__module__:
...
import pyscripts
import os, sys
sys.path.insert(0, os.path.dirname(os.path.abspath(pyscripts.__file__)))
...
version = pyscripts.version.__version__
# The full version, including alpha/beta/rc tags.
release = pyscripts.version.__version__
...
latex_documents = [
    (master_doc, 'pyscripts.tex', u'pyscripts Documentation',
...
man_pages = [
    (master_doc, 'pyscripts', u'pyscripts Documentation',
     [author], 1)
]
